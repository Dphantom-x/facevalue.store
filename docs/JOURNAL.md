...
| Date | File | Focus |
|---|---|---|
| 2026-06-22 | [2026-06-22-funnel-codegate.md](journal/2026-06-22-funnel-codegate.md) | Built the pilot kill-metric instrument: invite-only access-code gate + conversion funnel (drop_view→verify→claim, ≥15% verify-rate verdict in Studio); 20/20 specs |
